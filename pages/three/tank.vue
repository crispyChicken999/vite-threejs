...
const THREE = useNuxtApp().$THREE;
useHead({
  title: "Tank Playground",
  meta: [
    {
      hid: "description",
      name: "description",
      content: "Tank Playground",
    },
  ],
});
function init() {
  ...
  const wheelPositions = [
    [-carWidth / 2 - wheelThickness / 2, -carHeight / 2 + 0.1, carLength / 3],
    [carWidth / 2 + wheelThickness / 2, -carHeight / 2 + 0.1, carLength / 3],
    [-carWidth / 2 - wheelThickness / 2, -carHeight / 2 + 0.1, 0],
    [carWidth / 2 + wheelThickness / 2, -carHeight / 2 + 0.1, 0],
    [-carWidth / 2 - wheelThickness / 2, -carHeight / 2 + 0.1, -carLength / 3],
    [carWidth / 2 + wheelThickness / 2, -carHeight / 2 + 0.1, -carLength / 3],
  ];
  ...
  const domeRadius = 2;
  const domeWidthSubdivisions = 24;
  ...
  const targetGeometry = new THREE.SphereGeometry(0.5, 6, 4);
